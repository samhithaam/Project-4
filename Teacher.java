...
public class Teacher {
    ...
    // iterates through pointValues ArrayList and calculates total points, updates field variable
    ...
    public static void createQuiz() throws FileNotFoundException {
        ...
        // if there are already teacher submissions stored in text file
        ArrayList<String> teacherSubmissionsLocal = readFile();
        // if there aren't any teacher submissions stored in text file
    ...
    public static void editQuiz() {
        ...
        // if quizExists variable is false even after checking each element in teacherSubmissions ArrayList
        if (!quizExists) {
    ...
    public static ArrayList<String> readFile() {
        // if "quizList.txt" doesn't exist, return null
        // avoid FileNotFoundException
        if (!new File("src/quizList.txt").exists()) {
            return null;
        }
